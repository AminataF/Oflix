...
{
    /**
     * @Route("/", name="app_backoffice_person_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_backoffice_person_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_person_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_backoffice_person_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_person_delete", methods={"POST"})
     */
