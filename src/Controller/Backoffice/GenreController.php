...
{
    /**
     * @Route("/", name="app_backoffice_genre_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_backoffice_genre_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_genre_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_backoffice_genre_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_genre_delete", methods={"POST"})
     */
